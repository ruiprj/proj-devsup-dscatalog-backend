...
//		List<Long> categoryIds = "0".equals(categoryId) ? Arrays.asList() : stream.toList();
		...
		List<String> listStr = new ArrayList<String>(Arrays.asList(categoryId.split(",")));
		
		List<Long> listLong = new ArrayList<>();
		for (String id : listStr) {
			listLong.add(Long.parseLong(id));
		}
		
		List<Long> categoryIds = "0".equals(categoryId) ? Arrays.asList() : listLong;
